 ...
 * api/trash/[[...path]].ts
 * -------------------------
 * Catch-all handler for all trash endpoints (Hobby plan: ≤12 functions).
 *
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    // Resolve optional :id from catch-all segments
...
// Suppress unused import warning (randomUUID kept for parity with other handlers)
void randomUUID;
